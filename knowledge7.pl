...
pathDFS(Current,Destination,Visited,Result,Depth,MaxDepth,0) :-
	...
	Rem is MaxDepth-Depth,
	calculateHeuristic(Current,Destination,DiagDist),
	DiagDist =< Rem,
...
searchDFSV2(Start,Destination,MinPathLength,MaxPathLength) :-
	MinPathLength \= MaxPathLength,
	M is (MinPathLength+MaxPathLength)//2,
	pathDFSV2(Start,Destination,[],_,0,M,0),    %Singleton Variable Result
...
generate:-
	...
	randomCoordinate(C2), assert(covid(C2)),
...
%Something here gives false sometimes.
